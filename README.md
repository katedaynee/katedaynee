...
- 🌱 currently i'm developing an NFT platform aimed at promoting mass adoption of NFTs in Asia (simply focus not bias). after working on different types of web3 and technology products, i realized the NFT segment empowers the community much more strongly than others in blockchain field. living in its culture, i become happier and value all friends contributing to NFTs. we've connected by one thing on top: Respect.
...
*(is it from 0 for real 🙄😶idk-adding on jul 13 2026)*
...
*🤔hmm update on jul 13 2026, 🫯🙄 i left, few of them last (my goal, business lasts when with me or not)*
